...
/**
 * Created by chackomathew on 31/12/15.
 */
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *//*since the channel is of capacity 2, app waits for consumer to empty
        * a message out of channel to send the third message to the queue*//*
